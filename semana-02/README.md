...
* **Periodo:** 7 al 11 de septiembre de 2026
* **Modalidad:** Trabajo autónomo (6 horas)
* **Objetivo:** Dominar las herramientas base de computación científica siguiendo los estándares de **Software Carpentry**: control de versiones con Git/GitHub, navegación y procesamiento en la terminal Unix Shell, y fundamentos de análisis y visualización de datos en Python.
...
* [📁 evidencias/](./evidencias/): Informes formales, análisis conceptuales y registros de entrega académica.
* [📁 ejercicios/](./ejercicios/): Prácticas de laboratorio, scripts de shell, cuadernos de Jupyter y enlaces a repositorios satélite.
