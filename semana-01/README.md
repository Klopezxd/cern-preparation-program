...
* **Objetivo:** Familiarizarse con el portal de datos abiertos del experimento CMS (CERN), comprender la organización de datasets de colisiones y simulaciones Monte Carlo, y consolidar el uso profesional de Git y GitHub para el registro de evidencias.
...
* [📁 evidencias/](./evidencias/): Contiene los documentos formales de respuesta a las actividades de orientación, selección de datasets e inicio del portafolio.
* [📁 ejercicios/](./ejercicios/): Contiene el registro de ejecución de las prácticas interactivas en GitHub y guías complementarias de infraestructura local.
