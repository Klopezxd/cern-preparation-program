# Semana 3 — Trabajo Científico

* **Periodo:** 14 al 18 de septiembre de 2026
* **Modalidad:** Trabajo autónomo y colaborativo (6 horas regulares + 4 horas complementarias presenciales)
* **Objetivo:** Adentrarse en las herramientas del ecosistema CERN y CMS Open Data: ejecución de contenedores Docker para reproducibilidad científica, análisis de árboles ROOT y datasets NanoAOD mediante Python (`uproot` y `ROOT`), colaboración mediante ramas y revisión de Pull Requests en Git/GitHub, y redacción del primer borrador del CV técnico internacional en inglés bajo formato Europass.
...
| **Vie 18/09** | Autónoma | CV Técnico Internacional (Inglés) | Europass Curriculum Vitae | ✅ Completado |
...
* [📁 evidencias/](./evidencias/): Reportes técnicos y entregables formales para Moodle:
  ...
  * [Evidencia 3 — Primer CV Técnico Internacional](./evidencias/evidencia-03-cv-tecnico.md)
